...
ALTER TABLE inprog.users
    ADD FOREIGN KEY ("authority_id") REFERENCES inprog.authorities ("authority_id");

ALTER TABLE inprog.rooms
    ADD FOREIGN KEY ("category_id") REFERENCES inprog.categories ("category_id");

ALTER TABLE inprog.rooms
    ADD FOREIGN KEY ("facility_id") REFERENCES inprog.facilities ("facility_id");

ALTER TABLE inprog.rooms
    ADD FOREIGN KEY ("type_id") REFERENCES inprog.types ("type_id");

ALTER TABLE inprog.bookings
    ADD FOREIGN KEY ("room_id") REFERENCES inprog.rooms ("room_id");

ALTER TABLE inprog.bookings
    ADD FOREIGN KEY ("user_id") REFERENCES inprog.users ("user_id");